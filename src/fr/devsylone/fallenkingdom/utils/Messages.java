...
public enum Messages
{
    ...
    CMD_ERROR_LOOT_TABLES_API("cmd.error.loot-tables.api"),
    CMD_ERROR_ARGUMENT_MUST_CONTAIN_INTEGER("cmd.error.argument-must-contain-integer"),
    ...
    CONSOLE_START_OF_LANG_REPORT("console.start-of-lang-report"),
    CONSOLE_END_OF_LANG_REPORT("console.end-of-lang-report"),
    CONSOLE_VALUE_NOT_SET_IN_ANY_FILE_1("console.value.not-set-in-any-file.1"),
    CONSOLE_VALUE_NOT_SET_IN_ANY_FILE_2("console.value.not-set-in-any-file.2"),
    CONSOLE_ENABLE_ASYNCHRONOUS_TAB_COMPLETION("console.enable.asynchronous.tab-completion"),
    CONSOLE_MAIN_TIMER_ALREADY_RUNNING("console.main.timer.already-running"),
    CONSOLE_GAME_NOT_RUNNING("console.game-not-running"),
    CONSOLE_ADJUSTMENT_GAME_TIME("console.adjustment-game-time"),
    CONSOLE_AT("console.at"),
    CONSOLE_KICK_MESSAGE("console.kick.message"),
    CONSOLE_PLAYER_NAME_NOT_SET("console.player.name.not-set"),
    CONSOLE_SCOREBOARD_NULL("console.scoreboard.null"),
    ...
    CONSOLE_PLUGIN_CANNOT_BE_NULL("console.plugin.cannot-be-null"),
    ...
    CONSOLE_CANNOT_BE_INSTANTIATED("console.cannot-be-instantiated"),
    ...
    CONSOLE_SOUND_NOT_FOUND_1("console.sound.not-found.1"),
    CONSOLE_SOUND_NOT_FOUND_2("console.sound.not-found.2"),
    CONSOLE_CANNOT_FOUND_CLASS_1("console.cannot.found.class.1"),
    CONSOLE_CANNOT_FOUND_CLASS_2("console.cannot.found.class.2"),
    CONSOLE_NULL("console.null"),
    CONSOLE_ENUM("console.enum"),
    CONSOLE_SERVER_RESTART("console.server.restart"),
    CONSOLE_UNABLE_TO_GET_ACHIEVEMENT("console.unable.to-get.achievement"),
    CONSOLE_SUCCESS_DOES_NOT_EXIST_1("console.success.does-not.exist.1"),
    CONSOLE_SUCCESS_DOES_NOT_EXIST_2("console.success.does-not.exist.2"),
    CONSOLE_CANNOT_CONVERT_TO_BUKKIT_ITEM_STACK_1("console.cannot.convert.to-bukkit.item.stack.1"),
    CONSOLE_CANNOT_CONVERT_TO_BUKKIT_ITEM_STACK_2("console.cannot.convert.to-bukkit.item.stack.2"),
    CONSOLE_TEXT_COMPONENT_FIELD_NOT_FOUND("console.text.componment.field.not-found"),
    CONSOLE_DESTINATION_NOT_SET("console.destination.not-set"),
    CONSOLE_DESTINATION_WORLD_NOT_SET("console.destination.world.not-set"),
    CONSOLE_UNABLE_TO_REGISTER_FK_COMMAND("console.unable.to-register.fk.command"),
    CONSOLE_CHARGED_CREEPERS_NOT_USE("console.charged-creepers.not-use"),
    CONSOLE_COULD_NOT_GET_PACKET_MANAGER("console.could-not-get.packet-manager"),
    CONSOLE_RULE_DOES_NOT_LOADED("console.rule.does-not.loaded"),
    CONSOLE_UNKNOWN_MATERIAL("console.unknown.material"),
    CONSOLE_POTION_TYPE_MUST_NOT_BE_NULL("console.potion.type.mustNotBeNull"),
    CONSOLE_POTION_TYPE_IS_NOT_UPGRADABLE("console.potion.type.isNotUpgradable"),
    CONSOLE_POTION_TYPE_IS_NOT_EXTENDABLE("console.potion.type.isNotExtendable"),
    CONSOLE_POTION_CANNOT_BE_UPGRADABLE_AND_EXTENDABLE("console.potion.cannot-be.UpgradableAndExtendable"),
